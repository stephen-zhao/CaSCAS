...
case class Context private(
  ...
  var autoGeneratedTypeNextIndex: Int,
) {
  ...
  def consolidatedWith(ctxDelta: ContextMutationSet): Context = {
    ...
    Context(intermediateM ++ filteredReassigns, this.autoGeneratedTypeNextIndex)
  }
  ...
  def generateNextUniqueTypeIdentifier(): Identifier = {
    var supposedNextUniqueTypeIdentifier = Identifier("__TYPE_"+this.autoGeneratedTypeNextIndex)
    while (this.m contains supposedNextUniqueTypeIdentifier) {
      this.autoGeneratedTypeNextIndex = this.autoGeneratedTypeNextIndex + 1
      supposedNextUniqueTypeIdentifier = Identifier("__TYPE_"+this.autoGeneratedTypeNextIndex)
    }
    this.autoGeneratedTypeNextIndex = this.autoGeneratedTypeNextIndex + 1
    supposedNextUniqueTypeIdentifier
  }
